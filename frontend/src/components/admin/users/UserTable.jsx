        ...
        <div className="flex flex-wrap gap-y-2 sm:gap-y-0 justify-between items-center mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <button
              ...
              className="flex self-start items-center gap-2 my-auto px-3 py-2 rounded-lg border hover:bg-slate-200 hover:dark:bg-slate-900 transition-colors text-sm"
            >
              <span>Add User</span>
            </button>
            <input
            ...
            <tbody>
              {filteredUsers.length === 0 ? (
                ...
                filteredUsers.map((p) => (
                  <tr
                    key={p.id}
                    className="border-t border-gray-800 hover:bg-gray-200 hover:dark:bg-slate-900 transition-colors"
                  >
                    <td className="py-3 pl-2 flex items-center gap-3">
                      <img
                        src={
                          p.avatar || "https://ui-avatars.com/api/?name=User"
                        }
                        alt={p.name}
                    ...
                    <td>
                      <span
                        className={`text-[12px] text-white font-semibold bg-blue-800 px-2 py-1 rounded-xl capitalize`}
                      >
                        {p.role.code}
                      </span>
                    </td>
                    <td>
                      <span
                        className={`${
                          !p.isActive ? "bg-red-800" : ""
                        } text-[12px] text-white font-semibold bg-green-800 px-2 py-1 rounded-xl`}
                      >
